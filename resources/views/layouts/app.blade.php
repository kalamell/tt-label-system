    ...
    <div class="flex">
        <aside class="w-64 bg-slate-900 min-h-screen fixed left-0 top-0 z-30">
            ...
            <nav class="mt-4 px-3 space-y-1">
                ...
                <a href="{{ route('inventory.issue.form') }}"
                   class="flex items-center px-3 py-2.5 rounded-lg text-sm {{ request()->routeIs('inventory.issue*') ? 'bg-red-600 text-white' : 'text-slate-300 hover:bg-slate-800' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
